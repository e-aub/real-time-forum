    ...
    postElement.innerHTML = `
            <div class="post-header">
                ...
                <div class="post-header-info">
                    ...
                    <div class="post-time">${this.formatTimestamp(
                      post.created_at
                    )}</div>
                </div>
            ...
            <div class="post-actions">
                <button class="post-action" onclick="handleLike('${
                  post.post_id
                }')">👍 Like</button>
                <button class="post-action post-comment" data-postid="${post.post_id}">💬 Comment</button>
            </div>
        `;
    return postElement;
  }
